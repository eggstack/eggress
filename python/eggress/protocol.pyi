...
class _CompatServerHandle:
    """pproxy 2.7.9 compatible server handle returned by ProxySimple.start_server().

    Matches the asyncio.Server interface: close(), wait_closed(), sockets.
    """
