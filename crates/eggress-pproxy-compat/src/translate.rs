...
pub struct CombinedTranslation {
    ...
    /// Warnings identical across renderers.
    pub warnings: Vec<crate::warnings::CompatWarning>,
    /// Unsupported features identical across renderers.
    pub unsupported: Vec<crate::warnings::UnsupportedFeature>,
}
...
pub struct NativeTranslation {
    ...
    pub runtime: eggress_config::compile::RuntimeConfig,
    /// Warnings identical to the TOML-render path.
    pub warnings: Vec<crate::warnings::CompatWarning>,
    /// Unsupported features identical to the TOML-render path.
    pub unsupported: Vec<crate::warnings::UnsupportedFeature>,
}
...
fn intermediates_to_config_file(
